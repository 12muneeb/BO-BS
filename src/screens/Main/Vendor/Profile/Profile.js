  ...
  render() {
    ...
    const handleEdit = () => {
     this.setState({matchProfile: false})
      setTimeout(() => {
        NavService.navigate('EditProfileDetails')
      }, 700);
    }
    const handleInfo = () => {
      this.setState({matchProfile: false})
       setTimeout(() => {
        NavService.navigate('EditBussniesProfile')
       }, 700);
     }
     const handleUser = () => {
      this.setState({matchProfile: false})
       setTimeout(() => {
      NavService.navigate('EditPromotionDiscount')
       }, 700);
     }
    const buttonTabs = [
      {
                    ...
                    <View style={styles.bordersty}>
                      <View style={styles.content1}>
                        ...
                        <TouchableOpacity
                          ...
                          activeOpacity={0.9}
                          onPress={() =>
                            NavService.navigate('AddPromotionDiscount')
                          }>
                          <Img
                            local
                          ...
                          />
                          <CustomText text="Add Another" style={styles.add} />
                        </TouchableOpacity>
                      </View>
                    </View>
                    <FlatList
